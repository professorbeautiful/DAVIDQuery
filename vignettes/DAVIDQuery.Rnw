...
\begin{document}
%  NO GOOD ANYMORE?  \SweaveOpts{concordance=TRUE}
...
Dr. Richard Lempicki. The resource is accessed interactively at \url{https://david.ncifcrf.gov/}.
...
attribute-value strings is provided at \url{https://david.ncifcrf.gov/content.jsp?file=DAVID_API.html}.
...
directly from the page \url{https://david.ncifcrf.gov/tools.jsp}. 
...
<<chunk4, eval=FALSE>>=
### No longer working as of 2015-08-25
Sys.sleep(10)  ### Assure that queries are not too close in time.
